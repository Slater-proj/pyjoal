...
class Settings(BaseSettings):
    ...
    PEER_TIER1_SPEED_PERCENT: int = Field(default=40, description="Speed percentage for tier 1 (0-100)")
    PEER_TIER2_MAX_PEERS: int = Field(default=50, description="Tier 2 upper bound")
    PEER_TIER2_SPEED_PERCENT: int = Field(default=55, description="Speed percentage for tier 2 (0-100)")
