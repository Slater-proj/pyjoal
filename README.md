...
### Fonctionnalités de Discrétion (v1.7.4-1.7.4)
...
### Corrections précédentes (v1.7.4-1.7.4)
...
| `DEFAULT_CLIENT` | ❌ | qbittorrent-1.7.4.client | Client par défaut |
...
```json
{
  ...
  "maxUploadRate": 160,
  "simultaneousSeed": 20,
  "client": "qbittorrent-1.7.4.client",
...
PyJOAL v1.7.4+ intègre des mécanismes avancés pour éviter la détection par les trackers :
...
- **qBittorrent** (dernière stable : 1.7.4)
- **Deluge** (dernière stable : 1.7.4)
- **Transmission** (dernière stable : 1.7.4)
