...
### Corrections précédentes (v1.4.2-1.4.2)
...
| `DEFAULT_CLIENT` | ❌ | qbittorrent-1.4.2.client | Client par défaut |
...
```json
{
  ...
  "maxUploadRate": 160,
  "simultaneousSeed": 20,
  "client": "qbittorrent-1.4.2.client",
...
PyJOAL v1.4.2+ intègre des mécanismes avancés pour éviter la détection par les trackers :
...
- **qBittorrent** (dernière stable : 1.4.2)
- **Deluge** (dernière stable : 1.4.2)
- **Transmission** (dernière stable : 1.4.2)
